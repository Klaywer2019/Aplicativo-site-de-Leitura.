...
# Esta ponte permite que o GitHub Pages fale com seu PC sem o navegador barrar
...
if __name__ == '__main__':
    ...
    print("📡 Porta: 5000 | Escutando em 0.0.0.0 (Acesso Externo)\n")
